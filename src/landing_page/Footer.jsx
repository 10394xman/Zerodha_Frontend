...
function Footer() {
  return (
    <footer style={{ backgroundColor: "#fafafaff" }}>
      <div className="container p-5 mt-5">
        <div className="row mt-5">
          <div className="col-2">
            <img src="media/images/logo.svg" alt="" style={{ width: "90%" }} />
            <p>
        ...
        <div className="mt-5 text-small text-muted" style={{fontSize: "12px", opacity: "0.8"}}>
          <p>
